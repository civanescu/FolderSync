...
@pytest.mark.parametrize('source_folder, destination_folder, sleep_time, expected_exception',
...
def test_main(fix_time, caplog, source_folder, destination_folder, sleep_time, expected_exception):
...
@pytest.mark.parametrize('log_file, expected_exception', [
